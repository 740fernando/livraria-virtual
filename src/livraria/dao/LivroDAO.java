...
public class LivroDAO extends DAO<Livro> {
	...
	public List<Livro> getLivrosByTitulo(String titulo) throws DAOException{
		Query q = query("FROM Livro l WHERE upper(l.titulo) like :titulo order by l.titulo");
	...
	public Livro getLivroById(Integer id) throws DAOException{
		Query q = query("FROM Livro l WHERE l.id= :id");
		q.setParameter("id", id);
		return (Livro) q.uniqueResult();
	}
	/**
	 * Obtém todos os livros cadastrados, ordenados por titulo
	 *
	 *@return
	 *@throws DAOException
	 */
